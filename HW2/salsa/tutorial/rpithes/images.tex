...
\providecommand{\salsaversion}{1.1.3} 
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlfigureA{center1684}%
\begin{center}\vbox{\input{htmlcode/tokencont2nametoken.salsa.txt}
}\end{center}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{center1685}%
\begin{center}\vbox{\input{htmlcode/nonlinearCont.salsa.txt}
}\end{center}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{center1686}%
\begin{center}\vbox{\input{htmlcode/Fibonacci.salsa.txt}
}\end{center}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}
...
{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1730}%
\includegraphics[angle=0,scale=0.3]{heatavi2.eps}%
\lthtmlpictureZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap1732}%
